...
public class MyAdapter extends RecyclerView.Adapter<MyViewHolder> {
    ...
    public MyAdapter(Context context,List<SportData> mData) {
    ...
    public void onBindViewHolder(MyViewHolder viewHolder, int i) {
        viewHolder.textView_distance.setText(mData.get(i).getDistance()+"米");
        viewHolder.textView_step.setText(mData.get(i).getStep()+"步");
        viewHolder.textView_time.setText(mData.get(i).getTime());
        viewHolder.textView_recordtime.setText(mData.get(i).getRecordtime());
